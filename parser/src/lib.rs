...
mod tests {
    ...
    fn hello() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Hello(Hello{server_version: ProtocolVersion{major:1,minor:6}}))));
    }
    ...
    fn command_keep_alive() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Command(Command::KeepAlive))));
    }
    ...
    fn query_info() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Query(Query::Info))));
    }
    ...
    fn command_info_ack() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Command(Command::InfoAck))));
    }
    ...
    fn command_reset_options() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Command(Command::ResetOptions))));
    }
    ...
    fn command_enter() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Command(Command::Enter(Enter{
            x: 0, y: 503, sequence_number: 1, key_modifier_mask: 0,
        })))));
    }
    ...
    fn data_options() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Data(Data::Options(Options{})))));
    }
    ...
    fn data_clipboard() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Data(Data::Clipboard(Clipboard{})))));
    }
    ...
    fn data_mouse_move() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Data(Data::MouseMove(MouseMove{x:315,y:664})))));
    }
    ...
    fn data_key_down() {
        ...
        assert_eq!(command(&BYTE_ARRAY), Ok((&[][..], Message::Data(Data::KeyDown(KeyDown{key_id:99,key_modifier_mask:2,key_button:54})))));
    }
}
